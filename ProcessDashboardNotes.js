...
function ProcessDashboardNotes($) { 
	...
	*/
    ...
    /**
     * Get the general menu configs sent by the module ProcessDashboardNotes.
     *
	...
	function processMenuBuilderConfigs() {
		...
		var $jsProcessMenuBuilderConfigs = config.ProcessDashboardNotes;
		if (!jQuery.isEmptyObject($jsProcessMenuBuilderConfigs)) return $jsProcessMenuBuilderConfigs;
		else return false;
	}
	
	/**
     * Get the configs sent by the module ProcessDashboardNotes for Nested Sortable.
     *
    ...
    /**
     * Set the configs sent by the module ProcessDashboardNotes for Nested Sortable.
     *
     */
	...
	function init() {
		...
		*/
		...
		// nestedSortable custom configs for each menu (defined in ProcessDashboardNotes::nestedSortableConfigs())	
